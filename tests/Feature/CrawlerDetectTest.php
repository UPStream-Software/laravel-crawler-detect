...
class CrawlerDetectTest extends TestCase
{
    ...
    {
        parent::setUp();
        // TODO: подготовить тестовое хранилище метрик для тестирования на добавление записей
    }

    public function tearDown(): void
    {
        parent::tearDown();
        // TODO: произвести возврат к начальному состоянию тестового хранилища метрик
    }
